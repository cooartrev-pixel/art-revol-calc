...
export const banks: BankInfo[] = [
  {
    ...
    name: 'Ощадбанк',
    logo: '🏦',
    website: 'https://www.oschadbank.ua/kredyty/ipoteka',
  ...
  },
  {
    ...
    name: 'Укргазбанк',
    logo: '🌿',
    website: 'https://www.ukrgasbank.com/private/credits/mortgage/',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 3,
  ...
  },
  {
    ...
    name: 'Глобус Банк',
    logo: '🌐',
    website: 'https://globusbank.ua/kredity/yeoselya',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    name: 'Скай Банк',
    logo: '☁️',
    website: 'https://skybank.ua/credits/yeoselya',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    name: 'Сенс Банк',
    logo: '💡',
    website: 'https://sensebank.com.ua/private/kredity/ipoteka/',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    logo: '🏢',
    website: 'https://creditdnepr.com.ua/private/credits/ipoteka',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    name: 'ТАСКОМБАНК',
    logo: '🔷',
    website: 'https://tascombank.ua/credits/mortgage/',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    name: 'BISBANK',
    logo: '🔶',
    website: 'https://bisbank.com.ua/private/credits/',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
  ...
  },
  {
    ...
    name: 'РАДАБАНК',
    logo: '🏦',
    website: 'https://radabank.com.ua/credits/',
    rates: { privileged: 3, standard: 7 },
    minDownPayment: 20,
    maxDownPayment: 70,
    minTerm: 2,
